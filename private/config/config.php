...
$globalConfig   = [
  ...
  'script'     => ['/assets/js/menu.js', '/assets/js/main.js', '/assets/js/learn-slider.js', '/assets/js/calendar.js', '/assets/js/recommendation.js', '/assets/js/likes.js', '/assets/js/buttons.js', '/assets/js/fix-hash.js'],
  'base_url'   => $baseUrl,
  'lang'       => DEFAULT_LANG,
